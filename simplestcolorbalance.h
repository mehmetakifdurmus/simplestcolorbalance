...
cv::Mat simplestColorBalanceSingleChannel(cv::Mat& img, double sat_level1, double sat_level2, double num)
{
...
cv::Mat simplestColorBalance(cv::Mat& img, double sat_level1, double sat_level2, double num)
{
